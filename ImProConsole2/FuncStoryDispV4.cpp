...
int FuncStoryDispV4(int argc, char ** argv)
{
...
//    string fnameBigTable("./bigTable.txt");
    ...
    // set camera resolution if video source is a camera (i.e., vidName is a number, assuimg to be between 0 ~ 9)
	...
	FILE* fBigTable;
	int ferr;
	fnameBigTable = extFilenameRemoved(vidName) + std::string(".txt");
